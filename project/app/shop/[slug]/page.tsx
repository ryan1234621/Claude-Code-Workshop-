...
export default function ProductDetailPage() {
  ...
  if (!product) {
    return (
      <div className="pt-[var(--navbar-height)] min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="font-serif text-2xl font-bold mb-2">Product not found</p>
          <Link href="/shop" className="text-parmore-gold text-sm hover:underline">Back to Shop</Link>
        </div>
      </div>
    );
  }
